...
internal class CheckoutTest {
    ...
    private val withNoOffers = HashMap<String, Pair<Int, Int>>()

    private fun withOffers(quantity: Int, fruit: String, offerPrice: Int): MutableMap<String, Pair<Int, Int>> {
        val offers = mutableMapOf<String, Pair<Int, Int>>()
